...
右上の ①[Save] ボタンをクリックし、[Save Visualization] に ②[Sensor Data - Sampling Count]と入力し、③[Save] をクリックします。
...
[Save] 保存ボタンをクリックし、[Title]を[Sensor Data - Illuminance]に変更し、[Save]をクリックします。
